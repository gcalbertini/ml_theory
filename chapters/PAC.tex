...
\exercise{2.9}{
	...
	\begin{flalign*}
		...
		&\leq (1-\epsilon/3)^m + 2(2(1-\epsilon/6)^m) \leq e^{-\frac{m\epsilon}{3}}+4e^{-\frac{m \epsilon}{6}} =  e^{-\frac{2m\epsilon}{6}}+4e^{-\frac{m \epsilon}{6}}\leq 5e^{-\frac{m \epsilon}{6}} \leq \delta \implies m \geq \frac{3}{\epsilon}\log \frac{6}{\delta}\\
	\end{flalign*}
	...
	\begin{flalign*}
		...
		&= (p-1)(1-\frac{\epsilon/(2p-1)}{p-1})^m + (2p)(1-\frac{\epsilon/(2p-1)}{p})^m \leq (p-1)e^{-\frac{m\epsilon'}{p}} + 2pe^{-\frac{m \epsilon'}{p}}= (p-1)e^{-\frac{m \epsilon'}{p-1}}+2pe^{-\frac{m \epsilon'}{p}}\\
		&\leq (p-1)e^{-\frac{m \epsilon'}{p}} + 2pe^{-\frac{m \epsilon'}{p}} = (3p-1)e^{-\frac{m\epsilon}{p(2p-1)}}\\
		&\leq \delta \implies m \geq \frac{p(2p-1)}{\epsilon}\log \frac{3p-1}{\delta}
	\end{flalign*}
