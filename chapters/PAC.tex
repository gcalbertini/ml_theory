...
\exercise{2.9}{
	...
	interval of interest, so the learner assumes some instances are incorrectly false. Also, false positives
	...
	\begin{flalign*}
		...
		&\leq (1-\epsilon/3)^m + 2(2(1-\epsilon/3)^m) \leq e^{-\frac{m\epsilon}{3}}+4e^{-\frac{m \epsilon}{3}} = 5e^{-\frac{m \epsilon}{3}} \leq \delta \implies m \geq \frac{3}{\epsilon}\log \frac{5}{\delta}\\
	\end{flalign*}
	This shows that the union of closed intervals is also PAC learnable.
}
\section{Summary}
